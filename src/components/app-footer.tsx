  ...
  return (
    <footer className="bg-gray-100 text-gray-600 font-sans p-8 md:p-12 mt-12 rounded-t-xl">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <h3 className="text-2xl font-bold tracking-tight text-green-700 mb-4">World Peas</h3>
          <p className="text-sm">
        ...
        <div>
          ...
          <nav className="flex flex-col space-y-2 text-sm">
            <Link href="/shop" className="hover:text-green-700 transition-colors">All Produce</Link>
        ...
        <div>
          ...
          <nav className="flex flex-col space-y-2 text-sm">
            ...
            <Link href="/" className="hover:text-green-700 transition-colors">Newsstand</Link>
          </nav>
        </div>
      ...
      <div className="container mx-auto mt-8 pt-6 border-t border-gray-300 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
        <p>&copy; {new Date().getFullYear()} World Peas. All rights reserved.</p>
        <div className="flex space-x-4 mt-4 md:mt-0">
          <Link href="#" className="hover:text-green-700 transition-colors">Twitter</Link>
          <Link href="#" className="hover:text-green-700 transition-colors">Instagram</Link>
          <Link href="#" className="hover:text-green-700 transition-colors">Facebook</Link>
        </div>
      </div>
    </footer>
  );
