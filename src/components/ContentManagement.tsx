  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      <header className="flex items-center justify-between p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
        <div className="flex items-center space-x-6">
          ...
          <nav className="hidden md:flex space-x-4">
            ...
            <Link href="/" className="hover:text-gray-600">Who we are</Link>
          </nav>
        </div>
      ...
      <main className="container mx-auto p-6 md:p-12">
        <h1 className="text-4xl md:text-5xl font-serif font-light mb-8">Content</h1>
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="#" className="text-sm text-green-700 hover:underline">See full plan</Link>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-lg border border-gray-200">
            <p className="font-bold">
              Weekly plan <span className="text-sm text-gray-500 font-normal">・ 2 days left</span>
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
              ...
              <div className="md:w-1/3">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-sm text-green-700 hover:underline">Change post</Link>
                </div>
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded-lg border border-gray-200">
            <form className="space-y-4">
              <div>
                <label htmlFor="content-title" className="block text-sm font-semibold text-gray-700">
                  Title
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="content-description" className="block text-sm font-semibold text-gray-700">
                  Description
                </label>
                <textarea
