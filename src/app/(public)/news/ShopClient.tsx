          ...
          {sortedProducts.map((product) => ( 
            <div key={product.id} className="rounded-3xl bg-white p-4 shadow-lg">  
              <div className="aspect-square w-full rounded-2xl bg-gray-200"></div> 
                <div className="mt-4"> <h3 className="text-xl font-semibold">{product.name}</h3>
                ...
                <button className='bg-blue-500 text-white mt-4 px-4 w-full py-2 rounded-full'>click</button> 
              </div>
            </div> 
            ))}
        </div>
